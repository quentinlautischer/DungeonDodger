...
{
	public class CharacterEntity : DrawableGameComponent
	{
            ...
            :base(game)
        {
            if (characterSheetTexture == null)
            {
                ...
                {
                    characterSheetTexture = Texture2D.FromStream(game.GraphicsDevice, stream);
                }
            }
		...
		public CharacterEntity (Game game, GraphicsDevice graphicsDevice)
            :base(game)
		{
			//if (characterSheetTexture == null)
			//{
